package com.thetemz.desiaustralia.ui.home;
...
import com.thetemz.desiaustralia.adapter.NewsLetterAdapter;
...
import com.thetemz.desiaustralia.utility.NetworkUtil;
...
public class ENewsletterFragment extends Fragment {

    private RecyclerView recylerView;
    private ProgressBar progressBar;


    public ENewsletterFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_e_newsletter, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (NetworkUtil.checkNetworkStatus(getActivity())) {
            ...
            RetrofitHelper.getInstance().getNewsLetter(callback, "weekly-e-newsletter");
        } else {
        ...
        public void onResponse(Call<NewsLetterModel> call, Response<NewsLetterModel> response) {
            ...
            try {
                if (response.body().getStatus() == 1){
                    ...
                    NewsLetterAdapter adapter = new NewsLetterAdapter(getActivity(), arrayList, "newsletter");
